...
const Index = () => {
  return (
    <div className="space-y-4 sm:space-y-8">
      ...
      <div className="relative overflow-hidden rounded-2xl shadow-medical">
        ...
        >
          <div className="text-center text-white px-4">
            ...
            <p className="text-base sm:text-xl md:text-2xl opacity-90 max-w-2xl mx-auto">
      ...
      <div>
        <div className="mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Start Your Health Consultation</h2>
